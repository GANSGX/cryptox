                      ...
                      <div className="sessions-group">
                        ...
                        <div className="session-item primary current">
                          <div className="session-icon">
                            {getDeviceIcon(
                              (primarySession.device_info?.type as string) ||
                                "desktop",
                            )}
                          </div>
                          ...
                          <div className="session-info">
                            <div className="session-name">
                              {(primarySession.device_info?.name as string) ||
                                "Unknown Device"}
                              <span className="session-badge primary">
                                Primary Device
                              </span>
                            ...
                            <div className="session-details">
                              <span>
                                {(primarySession.device_info?.os as string) ||
                                  "Unknown OS"}
                              </span>
                    ...
                    {currentSession && !currentSession.is_primary && (
                      <div className="sessions-group">
                        ...
                        <div className="session-item current">
                          <div className="session-icon">
                            {getDeviceIcon(
                              (currentSession.device_info?.type as string) ||
                                "desktop",
                            )}
                          </div>
                          ...
                          <div className="session-info">
                            <div className="session-name">
                              {(currentSession.device_info?.name as string) ||
                                "Unknown Device"}
                              <span className="session-badge">Current</span>
                            </div>
                            <div className="session-details">
                              <span>
                                {(currentSession.device_info?.os as string) ||
                                  "Unknown OS"}
                              </span>
                              <span className="session-separator">•</span>
                        ...
                        <div className="sessions-list">
                          {otherSessions.map((session) => (
                            <div key={session.id} className="session-item">
                              ...
                              <div className="session-info">
                                <div className="session-name">
                                  {(session.device_info?.name as string) ||
                                    "Unknown Device"}
                                </div>
                                <div className="session-details">
                                  <span>
                                    {(session.device_info?.os as string) ||
                                      "Unknown OS"}
                                  </span>
                                  <span className="session-separator">•</span>
